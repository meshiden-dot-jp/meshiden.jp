  ...
  return (
    <div>
      ...
      <ul className='pt-4 pl-8 list-disc leading-10'>
        {/* <li><a className='b' href="https://www.rcl-aoyama.jp" target="_blank" rel="noopener noreferrer">戸辺研究室 <i className="fa-solid fa-arrow-up-right-from-square text-sm"></i></a></li> */}
