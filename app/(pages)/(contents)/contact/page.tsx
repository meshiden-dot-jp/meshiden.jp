    ...
    <div className="sm:w-[70%] w-[90%] m-auto pb-32 bg-white">
      ...
      >
        ...
        <AccordionItem value="mail">
          <AccordionTrigger><h2 id="mail" className="py-0 text-[1.296rem]">【一般】メールでお問い合わせ</h2></AccordionTrigger>
          <AccordionContent>
        ...
        {/* <AccordionItem value="mail2">
          <AccordionTrigger><h2 id="mail2" className="py-0 text-[1.296rem]">【研究】メールでお問い合わせ</h2></AccordionTrigger>
          <AccordionContent>
            <p>研究に関するメールでのお問い合わせは次のアドレス宛にお願いいたします。</p>
            <small>※ [at]を@に変換してご利用ください</small>
        ...
        <AccordionItem value="address">
          ...
          <AccordionContent>
            ...
            <address>
              〒252-5258 神奈川県相模原市淵野辺5-10-1 青山学院大学  O棟502号室 飯田優斗 宛
            </address>
          </AccordionContent>
        </AccordionItem> */}
      </Accordion>
